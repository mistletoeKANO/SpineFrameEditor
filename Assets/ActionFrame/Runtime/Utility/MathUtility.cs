...
namespace ActionFrame.Runtime
{
    ...
    public static class MathUtility
    {
        ...
        /// <returns></returns>
        public static Matrix4x4 MatrixRotate(Matrix4x4 matrix, float rot)
        {
            matrix.m00 = Mathf.Cos(-rot * Mathf.Deg2Rad);
            matrix.m01 = -Mathf.Sin(-rot * Mathf.Deg2Rad);
            matrix.m10 = Mathf.Sin(-rot * Mathf.Deg2Rad);
            matrix.m11 = Mathf.Cos(-rot * Mathf.Deg2Rad);
            return matrix;
        }
    }
}